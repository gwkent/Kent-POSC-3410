...
# Data
load("/Users/garrettkent/Downloads/Clemson/POSC Research Methods/autm_example_df.Rdata")
gtd_raw <- read_csv("/Users/garrettkent/Downloads/Clemson/POSC Research Methods/gtd_raw.csv")
