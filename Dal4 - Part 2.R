...
Answer1 <- "This visualization provides evidence against the alternative hypothesis, as there does not appear to be a statistically significant difference between the two sexes." 
...
Answer2 <- "This visualization provides evidence against the null hypothesis, as there does appear to be a statistically significant different between the two sexes. The amount of respondents who chose 'too little' or 'don't know' varies significantly between men and women."
